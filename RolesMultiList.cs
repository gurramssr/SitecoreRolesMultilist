...
namespace sc8.Services.SitecoreCustomEmailAction.RolesMultiListField
{
    ...
    {
        private IRolesField _customRolesField;
        private IRolesField CustomRolesField
        {
            get
            {
                if (_customRolesField == null)
                {
                    _customRolesField = CreateNewRolesField();
                }

                return _customRolesField;
            }
        }
        ...
        {
            return CustomRolesField.GetSelectedRoles();
        }

        protected IEnumerable<Role> GetUnselectedRoles()
        {
            return CustomRolesField.GetUnselectedRoles();
        }

        protected string GetProviderRoleKey(Role role)
        {
            return CustomRolesField.GetProviderRoleKey(role);
        }
        ...
        {
            return global::sc8.Services.SitecoreCustomEmailAction.RolesMultiListField.RolesField.CreateNewRolesField(Source, Value);
        }
    }
}
